...
<head>
    ...
    <title>SDFC Bank - Withdraw Amount</title>
    <style>
        /* Internal CSS Styles */
...
<body>
    ...
    <form action="/dashboard" method="post">
        <h1>Withdraw Money to Your Account</h1><br>
        ...
        <label for="deposit">Wirhdraw Amount</label>
        <input type="text" id="name1" name="withdraw" required>
